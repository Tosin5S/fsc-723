...
public class ENcrypt {
    ...
    public static void main(String[] args) {
        ...
        String new_textAlv = new String(textAlv_char); //converts textAlv_char back to a string
       ...
       char [] textBlv_char = new char [textBlv.length()]; //converting substring textBlv to new character array textBlv_char
        ...
        String new_textBlv = new String(textBlv_char); //converts textBlv_char back to a string
